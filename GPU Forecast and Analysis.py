...
# select columns that represents key data for our project.
...
# GPU Memory vs Year of Release by Manufacturer
# Circle size represents maximum resolution that is supported by GPU.
...
# Predicting GPUs mean memory size in 2030

memory_2030 = exponentialCurve(2030, *popt)


# In[29]:


print("Predicted mean size of GPU memory in 2030 is " + str(round(int(memory_2030) / 1024, 2)) + " GB.")
...
dataset['Manufacturer'].value_counts().plot(kind='pie')
